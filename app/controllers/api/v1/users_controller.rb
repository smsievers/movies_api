class Api::v1::UsersController < ApplicationController
    ...
    def create
        ...
        render json: { error: "There was a probem saving your user"}, status: :unprocessable_entity and return unless @user
        render json: @user.profile, status: :ok
    end

    def logout
        render json: {error: "There was a problem logging you out"}, status: :unprocessable_entity and return unless UsersService.logout(current_user)
